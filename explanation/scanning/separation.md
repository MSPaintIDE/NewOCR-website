...
<src data-gh="https://github.com/MSPaintIDE/NewOCR/blob/2dcf3f19c218e233943dbaf12361f54eea8bb472/src/main/java/com/uddernetworks/newocr/recognition/OCRActions.java#L69-L81">The first thing the OCR does it go through all black pixels of the input image (after <src data-gh="https://github.com/MSPaintIDE/NewOCR/blob/2dcf3f19c218e233943dbaf12361f54eea8bb472/src/main/java/com/uddernetworks/newocr/recognition/OCRScan.java#L111">image binarization</src>), and for every black pixel it gets, it gets all touching pixels recursively.</src> These are then compiled into a single character object.